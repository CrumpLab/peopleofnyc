...
This is the course website for Seminar 2: People of NYC, taught by [Dr. Matthew Crump](https://crumplab.com) in Spring 2023, for the [Macaulay Honor's program at Brooklyn College of CUNY](https://www.brooklyn.cuny.edu/web/academics/honors-academy/programs/macaulay.php). **This website is currently under development**
...
-  Understand the advantages and disadvantages of different approaches and methodologies used by the
social sciences.
- Increase their understanding of past and present issues including colonialism, migration, immigration,
race, and ethnicity by analyzing a variety of sources (current, historical, primary, secondary) and by
engaging in active discussion about those issues.
-  Present their research to a public audience through a final project that may be completed by small
